...
from homeassistant.components.climate import (ClimateDevice, PLATFORM_SCHEMA, 
                                                ...
                                                STATE_COOL, STATE_HEAT, STATE_DRY, STATE_FAN_ONLY, STATE_OFF, STATE_AUTO)
...
CONST_STATE_CMD_MAP = {STATE_COOL:0, STATE_HEAT:1, STATE_DRY:2, STATE_FAN_ONLY:3, STATE_OFF:4, STATE_AUTO:5}
...
class Thermostat(ClimateDevice):
    ...
    def __init__(self, name, ac_name, host, port, acdata):
        ...
        self._host = host
        self._port = port
        self._operation_list = [STATE_OFF, STATE_AUTO, STATE_COOL, STATE_HEAT, STATE_DRY, STATE_FAN_ONLY]
